...
for (var m = 0; m < menus.length; m++) {
    ...
    var solidColor = menus[m].solidColor;
    var hoverColor = menus[m].hoverColor;
    var slideTime = menus[m].slideTime;


    var horizontal_navigation = document.querySelectorAll('.horizontal-' + menus[m].classSuffix);
    var vertical_navigation = document.querySelectorAll('.vertical-' + menus[m].classSuffix);
